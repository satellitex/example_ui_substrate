		...
		return (<div>
			...
			<Segment style={{margin: '1em'}} padded>
				<Header as='h2'>
					...
					<Header.Content>
						SetPayment
						<Header.Subheader>Set Payment below game.</Header.Subheader>
					</Header.Content>
				</Header>
				<div style={{paddingBottom: '1em'}}>
					<div style={{fontSize: 'small'}}>payment</div>
					<BalanceBond bond={this.payment}/>
				</div>
				<TransactButton
					content="SetPayment"
					icon='game'
					tx={{
						sender: runtime.sudo.key,
						call: calls.demo.setPayment(this.payment)
					}}
				/>
			</Segment>
